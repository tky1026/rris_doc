...
Also read :ref:`common pitfalls <code-rst-pitfall>` in order to avoid common mistakes with the syntax or make sure to :ref:`setup your editor or IDE <howto-tools-doc>` correctly to detect and show errors in the syntax.
